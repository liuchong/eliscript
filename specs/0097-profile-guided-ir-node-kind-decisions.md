...
- 244,173 bytes across eleven maintained compiler modules
- 22,965 real IR nodes and 17 explicit boundary values
...
The reviewed median is 46.109000 ms for native `Set` membership and
427.151583 ms for the retained linear reference, a 9.263952x local speedup.

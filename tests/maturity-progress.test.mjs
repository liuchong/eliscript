...
test("maturity progress is derived from explicit core acceptance units", async () => {
  ...
  expect(report).toEqual({
    ...
    implementation: {
      completed: 26,
      total: 42,
      completedPercent: 61.9,
      remaining: 16,
      remainingPercent: 38.1,
      milestones: {
        M7: { completed: 6, total: 6, completedPercent: 100, remaining: 0, remainingPercent: 0 },
        M8: { completed: 5, total: 7, completedPercent: 71.4, remaining: 2, remainingPercent: 28.6 },
      ...
      incomplete: [
        "M8-04", "M8-06", "M10-06", "M11-03", "M11-04",

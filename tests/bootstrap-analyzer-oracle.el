;;; bootstrap-analyzer-oracle.el --- Normalize seed analyzer output -*- lexical-binding: t; -*-
...
(defun eliscript-bootstrap-analyzer-oracle--ascii-json (json)
...
(let ((fixture (getenv "ELISCRIPT_ANALYZER_FIXTURE")))
  (unless fixture
    (error "ELISCRIPT_ANALYZER_FIXTURE is required"))
  (princ
   (eliscript-bootstrap-analyzer-oracle--ascii-json
    (decode-coding-string
     (json-serialize
      (eliscript-bootstrap-tests-analyzer-results fixture)
      :null-object nil
      :false-object :false)
     'utf-8-unix))))

;;; bootstrap-analyzer-oracle.el ends here

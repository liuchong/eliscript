;;; bootstrap-expander-oracle.el --- Normalize seed expander output -*- lexical-binding: t; -*-
...
(defun eliscript-bootstrap-expander-oracle--ascii-json (json)
...
(let ((fixture (getenv "ELISCRIPT_EXPANDER_FIXTURE")))
  (unless fixture
    (error "ELISCRIPT_EXPANDER_FIXTURE is required"))
  (princ
   (eliscript-bootstrap-expander-oracle--ascii-json
    (decode-coding-string
     (json-serialize
      (eliscript-bootstrap-tests-expander-results fixture)
      :null-object nil
      :false-object :false)
     'utf-8-unix))))

;;; bootstrap-expander-oracle.el ends here

;;; bootstrap-ir-oracle.el --- Normalize seed IR output -*- lexical-binding: t; -*-
...
(defun eliscript-bootstrap-ir-oracle--ascii-json (json)
...
(let ((fixture (getenv "ELISCRIPT_IR_FIXTURE")))
  (unless fixture
    (error "ELISCRIPT_IR_FIXTURE is required"))
  (princ
   (eliscript-bootstrap-ir-oracle--ascii-json
    (decode-coding-string
     (json-serialize
      (eliscript-bootstrap-tests-ir-results fixture)
      :null-object nil
      :false-object :false)
     'utf-8-unix))))

;;; bootstrap-ir-oracle.el ends here

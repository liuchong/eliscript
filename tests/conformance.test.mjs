...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 117,
      statuses: { draft: 1, accepted: 87, stable: 29 },
      implementations: {
        "in-progress": 3,
        implemented: 114,
      },
      coveredImplemented: 114,
    },
    features: {
      total: 114,
      evidence: 390,
      domains: {
        ...
        toolchain: { features: 3, evidence: 11 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 85,
      planningSpecifications: 3,
      stableFeatures: 29,
      provisionalFeatures: 85,
    },
  });
});

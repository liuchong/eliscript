...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 97,
      statuses: { draft: 1, accepted: 67, stable: 29 },
      implementations: {
        "in-progress": 3,
        implemented: 94,
      },
      coveredImplemented: 94,
    },
    features: {
      total: 94,
      evidence: 317,
      domains: {
        ...
        compiler: { features: 10, evidence: 25 },
        ...
        stdlib: { features: 20, evidence: 63 },
        tooling: { features: 1, evidence: 2 },
        worker: { features: 5, evidence: 20 },
      },
    },
    baseline: {
      stableSpecifications: 29,
      provisionalSpecifications: 65,
      planningSpecifications: 3,
      stableFeatures: 29,
      provisionalFeatures: 65,
    },
  });
});

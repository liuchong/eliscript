...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 109,
      statuses: { draft: 1, accepted: 79, stable: 29 },
      implementations: {
        "in-progress": 3,
        implemented: 106,
      },
      coveredImplemented: 106,
    },
    features: {
      total: 106,
      evidence: 355,
      domains: {
        ...
        bootstrap: { features: 10, evidence: 20 },
        compiler: { features: 15, evidence: 41 },
        language: { features: 19, evidence: 72 },
        ...
        toolchain: { features: 1, evidence: 4 },
        tooling: { features: 1, evidence: 2 },
        worker: { features: 7, evidence: 29 },
      },
    },
    baseline: {
      stableSpecifications: 29,
      provisionalSpecifications: 77,
      planningSpecifications: 3,
      stableFeatures: 29,
      provisionalFeatures: 77,
    },
  });
});

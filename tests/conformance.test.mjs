...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 142,
      statuses: { draft: 1, accepted: 109, stable: 31, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 138,
        superseded: 1,
      },
      coveredImplemented: 138,
    },
    features: {
      total: 138,
      evidence: 467,
      domains: {
        ...
        quality: { features: 21, evidence: 54 },
        runtime: { features: 15, evidence: 93 },
        stdlib: { features: 21, evidence: 66 },
    ...
    baseline: {
      stableSpecifications: 31,
      provisionalSpecifications: 107,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 31,
      provisionalFeatures: 107,
    },
  });
});

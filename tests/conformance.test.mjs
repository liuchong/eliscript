...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 141,
      statuses: { draft: 1, accepted: 108, stable: 31, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 137,
        superseded: 1,
      },
      coveredImplemented: 137,
    },
    features: {
      total: 137,
      evidence: 465,
      domains: {
        ...
        quality: { features: 20, evidence: 53 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 106,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 31,
      provisionalFeatures: 106,
    },
  });
});

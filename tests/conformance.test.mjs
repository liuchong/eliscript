...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 174,
      statuses: { draft: 1, accepted: 3, stable: 169, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 170,
        superseded: 1,
      },
      coveredImplemented: 170,
    },
    features: {
      total: 170,
      evidence: 664,
      domains: {
        ...
        language: { features: 32, evidence: 138 },
        ...
        stdlib: { features: 38, evidence: 151 },

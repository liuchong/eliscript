...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 120,
      statuses: { draft: 1, accepted: 90, stable: 28, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 116,
        superseded: 1,
      },
      coveredImplemented: 116,
    },
    features: {
      total: 116,
      evidence: 398,
      domains: {
        ...
        toolchain: { features: 4, evidence: 15 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 88,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 28,
      provisionalFeatures: 88,
    },
  });
});

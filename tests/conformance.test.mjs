...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 138,
      statuses: { draft: 1, accepted: 106, stable: 30, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 134,
        superseded: 1,
      },
      coveredImplemented: 134,
    },
    features: {
      total: 134,
      evidence: 458,
      domains: {
        ...
        quality: { features: 17, evidence: 46 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 104,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 30,
      provisionalFeatures: 104,
    },
  });
});

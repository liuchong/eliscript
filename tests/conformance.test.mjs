...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 131,
      statuses: { draft: 1, accepted: 99, stable: 30, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 127,
        superseded: 1,
      },
      coveredImplemented: 127,
    },
    features: {
      total: 127,
      evidence: 436,
      domains: {
        ...
        quality: { features: 10, evidence: 24 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 97,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 30,
      provisionalFeatures: 97,
    },
  });
});

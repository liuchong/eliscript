...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 137,
      statuses: { draft: 1, accepted: 105, stable: 30, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 133,
        superseded: 1,
      },
      coveredImplemented: 133,
    },
    features: {
      total: 133,
      evidence: 453,
      domains: {
        ...
        quality: { features: 16, evidence: 41 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 103,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 30,
      provisionalFeatures: 103,
    },
  });
});

...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 128,
      statuses: { draft: 1, accepted: 96, stable: 30, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 124,
        superseded: 1,
      },
      coveredImplemented: 124,
    },
    features: {
      total: 124,
      evidence: 427,
      domains: {
        ...
        quality: { features: 8, evidence: 17 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 94,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 30,
      provisionalFeatures: 94,
    },
  });
});

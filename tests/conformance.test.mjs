...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 139,
      statuses: { draft: 1, accepted: 107, stable: 30, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 135,
        superseded: 1,
      },
      coveredImplemented: 135,
    },
    features: {
      total: 135,
      evidence: 460,
      domains: {
        ...
        quality: { features: 18, evidence: 48 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 105,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 30,
      provisionalFeatures: 105,
    },
  });
});

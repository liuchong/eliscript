...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 130,
      statuses: { draft: 1, accepted: 98, stable: 30, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 126,
        superseded: 1,
      },
      coveredImplemented: 126,
    },
    features: {
      total: 126,
      evidence: 434,
      domains: {
        ...
        quality: { features: 9, evidence: 22 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 96,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 30,
      provisionalFeatures: 96,
    },
  });
});

...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 56,
      statuses: { draft: 1, accepted: 27, stable: 28 },
      implementations: {
        "in-progress": 3,
        implemented: 53,
      },
      coveredImplemented: 53,
    },
    features: {
      total: 53,
      evidence: 124,
      domains: {
        ...
        runtime: { features: 5, evidence: 30 },
        stdlib: { features: 8, evidence: 22 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 25,
      planningSpecifications: 3,
      stableFeatures: 28,
      provisionalFeatures: 25,
    },
  });
});

...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 148,
      statuses: { draft: 1, accepted: 4, stable: 142, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 144,
        superseded: 1,
      },
      coveredImplemented: 144,
    },
    features: {
      total: 144,
      evidence: 547,
      domains: {
        ...
        language: { features: 23, evidence: 94 },
        ...
        quality: { features: 24, evidence: 78 },
    ...
    baseline: {
      stableSpecifications: 142,
      provisionalSpecifications: 2,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 142,
      provisionalFeatures: 2,
    },
  });
});

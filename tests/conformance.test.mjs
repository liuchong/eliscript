...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 69,
      statuses: { draft: 1, accepted: 40, stable: 28 },
      implementations: {
        "in-progress": 3,
        implemented: 66,
      },
      coveredImplemented: 66,
    },
    features: {
      total: 66,
      evidence: 198,
      domains: {
        ...
        language: { features: 11, evidence: 29 },
        ...
        stdlib: { features: 11, evidence: 37 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 38,
      planningSpecifications: 3,
      stableFeatures: 28,
      provisionalFeatures: 38,
    },
  });
});

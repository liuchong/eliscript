...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 125,
      statuses: { draft: 1, accepted: 93, stable: 30, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 121,
        superseded: 1,
      },
      coveredImplemented: 121,
    },
    features: {
      total: 121,
      evidence: 417,
      domains: {
        ...
        quality: { features: 6, evidence: 14 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 91,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 30,
      provisionalFeatures: 91,
    },
  });
});

...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 88,
      statuses: { draft: 1, accepted: 59, stable: 28 },
      implementations: {
        "in-progress": 3,
        implemented: 85,
      },
      coveredImplemented: 85,
    },
    features: {
      total: 85,
      evidence: 279,
      domains: {
        ...
        language: { features: 16, evidence: 58 },
        ...
        runtime: { features: 14, evidence: 89 },
        stdlib: { features: 20, evidence: 63 },
        tooling: { features: 1, evidence: 2 },
        worker: { features: 3, evidence: 10 },
      },
    },
    baseline: {
      stableSpecifications: 28,
      provisionalSpecifications: 57,
      planningSpecifications: 3,
      stableFeatures: 28,
      provisionalFeatures: 57,
    },
  });
});

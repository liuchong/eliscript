...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 59,
      statuses: { draft: 1, accepted: 30, stable: 28 },
      implementations: {
        "in-progress": 3,
        implemented: 56,
      },
      coveredImplemented: 56,
    },
    features: {
      total: 56,
      evidence: 144,
      domains: {
        ...
        language: { features: 7, evidence: 13 },
        ...
        runtime: { features: 7, evidence: 44 },
        stdlib: { features: 9, evidence: 28 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 28,
      planningSpecifications: 3,
      stableFeatures: 28,
      provisionalFeatures: 28,
    },
  });
});

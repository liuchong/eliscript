...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 158,
      statuses: { draft: 1, accepted: 3, stable: 153, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 154,
        superseded: 1,
      },
      coveredImplemented: 154,
    },
    features: {
      total: 154,
      evidence: 591,
      domains: {
        ...
        language: { features: 24, evidence: 98 },
        ...
        stdlib: { features: 30, evidence: 118 },

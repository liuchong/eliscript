...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 127,
      statuses: { draft: 1, accepted: 95, stable: 30, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 123,
        superseded: 1,
      },
      coveredImplemented: 123,
    },
    features: {
      total: 123,
      evidence: 426,
      domains: {
        ...
        quality: { features: 7, evidence: 16 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 93,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 30,
      provisionalFeatures: 93,
    },
  });
});

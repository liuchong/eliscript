...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 84,
      statuses: { draft: 1, accepted: 55, stable: 28 },
      implementations: {
        "in-progress": 3,
        implemented: 81,
      },
      coveredImplemented: 81,
    },
    features: {
      total: 81,
      evidence: 250,
      domains: {
        ...
        language: { features: 14, evidence: 43 },
        ...
        runtime: { features: 13, evidence: 82 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 53,
      planningSpecifications: 3,
      stableFeatures: 28,
      provisionalFeatures: 53,
    },
  });
});

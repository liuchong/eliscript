...
test("repository specifications have complete conformance evidence", async () => {
  ...
  expect(report).toEqual({
    ...
    specifications: {
      total: 132,
      statuses: { draft: 1, accepted: 100, stable: 30, superseded: 1 },
      implementations: {
        "in-progress": 3,
        implemented: 128,
        superseded: 1,
      },
      coveredImplemented: 128,
    },
    features: {
      total: 128,
      evidence: 438,
      domains: {
        ...
        quality: { features: 11, evidence: 26 },
    ...
    baseline: {
      ...
      provisionalSpecifications: 98,
      planningSpecifications: 3,
      supersededSpecifications: 1,
      stableFeatures: 30,
      provisionalFeatures: 98,
    },
  });
});

...
| [`dogfood/`](dogfood/README.md) | Hybrid GitHub-native publishing and comment architecture | Design complete; Markdown static slice runs; remote providers pending |

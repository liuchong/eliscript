...
| [`browser-playground/`](browser-playground/README.md) | The compiler running in the browser, compiling and executing Eliscript in the page | `bun run build:browser-playground` |
...
| [`dogfood/`](dogfood/README.md) | Hybrid GitHub-native publishing and comment architecture | Design complete; Markdown slice runs locally and as a packaged Node Action; remote providers pending |

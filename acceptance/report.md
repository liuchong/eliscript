...
- Source commit: `722da0f15903a46cd978ccc07c4c37a4349feff0`
- Source tree: `05b86f9ccde6ca7c24c76ec251d3fc2be0bfa2d0`
- Contract: `contracts/final-acceptance.json` (`fc7760bdccc644b014b3513e4020f3647e3128e54676481d1515504967f2651d`)
- Generated: 2026-09-07T22:32:08.301Z
...
Results: 20 pass, 15 incomplete, 0 fail, 35 total.
...
| AC-03 Deterministic diagnostics | incomplete | partial | Close exact diagnostic parity over every final negative conformance case. |
...
| AC-07 Repeated determinism | incomplete | partial | Run and retain twenty clean identity-equivalent acceptance builds. |
| AC-08 Clean project workflow | incomplete | partial | Close the documented clean configured check, format-check, build, run, and watch workflow. |
...
| PD-07 Host Interop | incomplete | partial | Add the maintained JavaScript package fixture and pass the full supported matrix. |
...
| --- | --- | --- | ---: | ---: | --- |
| core-suite | `make test-core` | pass | 0 | 469566.262 | `888f9543dea59163e5574d0b68d79057b9701361bb2e4577d544744d63e2b274` |
| strict-byte-compile | `make byte-compile` | pass | 0 | 1099.57 | `4110c50ff8be0d96e678ed5ef31967a2aca72a86558181796ef5f14b5a350c3e` |
...
| `acceptance/manifest.json` | `f05c617968481a28ff5d6c03ae081ca3fb61beff4052f85c60540f9b6cb01e90` |
| `acceptance/report.md` | `8d030ebe8eb9a726249b092f31e799b3005209355dd088b502b42dab18906b35` |
...
| `contracts/compatibility-baseline.json` | `82246f529f89de9f53d4d5a008adf4200da7e39c04592ed8cde29257ca9df9b4` |
| `contracts/compatibility-matrix.json` | `cb8ef575762f556a13a2ad8113ba56448ea5c14113ca438184e2527ee1eeb38d` |
| `contracts/core-acceptance-corpus.json` | `4fbec5fcc4592741202fb3f8d402fecdd97d4bcbae37bd46a18af13db354e398` |
...
| `contracts/maturity-progress.json` | `da045455b6a9a473d77187285bf3fc988ee060829fddf9a145571fa5363781f9` |
...
| `specs/index.json` | `aca538f00724744edaae52d898d4eab4f2afa283820e0fd3f680224564b9aad4` |
...
| `tests/conformance.test.mjs` | `2fa783f576453e32dbac36978f4f067ef2a6ed069c718b0c1056c95b84eb67ee` |
| `tests/conformance/manifest.json` | `b558324d0a2915cc1ccf241bfe6efd0694dfa3a4fe84075c2a63769278b3e95d` |
...
| `tests/final-acceptance.test.mjs` | `b6a07d8833ea4e9730dab7bb208d6556c41da9d88ade051fcf3630d314bb289e` |
...
| `tests/onboarding-docs.test.mjs` | `c9d6613c2c739e0daf0d584d6dea94176148ea2a02cf6d7df766d69d4b6d9612` |
